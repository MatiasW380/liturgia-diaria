...
export default function Visperas() {
    ...
    return (
      <Layout>
        <div className="card card-visperas">
          <h2 className="card-title" style={{ display: "flex", alignItems: "center", gap: "10px" }}><Sunset size={22} color="#c9a44c" strokeWidth={1.5} /> Vísperas</h2>
  ...
  return (
    <Layout>
      <div className="card card-visperas">
        <h2 className="card-title" style={{ display: "flex", alignItems: "center", gap: "10px" }}><Sunset size={22} color="#c9a44c" strokeWidth={1.5} /> {datos.titulo}</h2>
